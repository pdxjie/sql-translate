...
public class TransFromServiceImpl implements TransFromService {
     ...
     */
    @Override
    public DataResult transformSql(TransFromVo transFrom) throws Exception {
     ...
     * @return
     */
    private DataResult getCreateSql(String textarea, List<ReplaceFieldVo> replaceForms) {
        int index = 0;
     ...
     * @return
     */
    private DataResult getUpdateSql(String textarea, List<ReplaceFieldVo> replaceForms) {
        Integer index = 0;
     ...
     * @return
     */
    private DataResult getInsertSql(String textarea, List<ReplaceFieldVo> replaceForms) throws Exception {
